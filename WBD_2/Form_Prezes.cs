...
namespace WBD_2
{
    public partial class Form_Prezes : Form
    {
        OracleConnection polaczenie;
        bool Delete = true;
        bool Edycja = true;
        public Form_Prezes(ref OracleConnection connection)
        {
            ...
            comboBoxWybor.Items.Add("SPRZETY");
            ...
            combobox_atrybutGora.Items.Add("SPRZETY");
            ...
            control_manager_dialog = new OracleCommand("SELECT * FROM POJAZDY ORDER BY ID_POJAZDU ASC", polaczenie);
            data_adapter = new OracleDataAdapter(control_manager_dialog);
            comand_builder = new OracleCommandBuilder(data_adapter);

            wybor_sprzet = new DataSet();
            data_adapter.Fill(wybor_sprzet);
        ...
        private DataSet wybor_danych, wybor_pracownicy, wybor_mieszkania, wybor_sprzet, wybor_wynagrodzenia;
        ...
        private void button_dodaj_Click(object sender, EventArgs e)
        {
            ...
            else if (combobox_atrybutGora.Text == "SPRZETY")
            {
        ...
        protected void button_pokaz_dane_Click(object sender, EventArgs e)
       
        {
            ...
            else if (combobox_atrybutGora.Text == "SPRZETY")
            {
                ...
                dataGridView1.DataSource = wybor_sprzet.Tables[0];
                Delete = true;
                Edycja = true;
        ...
        private void button_szukaj_Click_1(object sender, EventArgs e)
        {
            ...
            else if (comboBoxWybor.Text == "SPRZETY")
            {
                try
                {
                    wyswietlanie_danych = new DataView(wybor_sprzet.Tables[0], comboBox_atrybuty.Text + "= '" + textBox_fraza.Text + "' ", comboBox_atrybuty.Text + " Desc", DataViewRowState.CurrentRows);
                    dataGridView1.DataSource = wyswietlanie_danych;
                }
                catch (Exception ex)
                {
        ...
        private void comboBoxWybor_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                for (int i = 0; i < wybor_sprzet.Tables[0].Columns.Count; i++)
                {
                    comboBox_atrybuty.Items.Add(wybor_sprzet.Tables[0].Columns[i].ToString());
                }
            }
